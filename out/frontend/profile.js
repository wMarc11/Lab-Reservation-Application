...
const profileUserID = (0, frontendUtil_1.queryElement)("main").dataset.profileid;
const profileDetails = (0, frontendUtil_1.queryElement)(".profile-details");
const block = (0, frontendUtil_1.queryElement)(".block1");
// const formActions = document.querySelector(".form-actions");
const editBtn = (0, frontendUtil_1.queryElement)("#editBtn");
const saveBtn = (0, frontendUtil_1.queryElement)("#saveBtn");
const cancelBtn = (0, frontendUtil_1.queryElement)("#cancelBtn");
const changePhotoBtn = (0, frontendUtil_1.queryElement)("#changePhotoBtn");
const photoInput = (0, frontendUtil_1.queryElement)("#photoInput");
const profileImage = (0, frontendUtil_1.queryElement)("#profileImage");
...
if (accountJSON) {
    ...
    const dashboardLink = (0, frontendUtil_1.queryElement)('.sidebar a[href="dashboard.html"]');
...
const reservationsBtn = (0, frontendUtil_1.queryElement)("#reservationsBtn");
const upcomingBtn = (0, frontendUtil_1.queryElement)("#upcomingBtn");
const reservationList = (0, frontendUtil_1.queryElement)("#reservationList");
const listTitle = (0, frontendUtil_1.queryElement)("#listTitle");
const upcomingTableBody = (0, frontendUtil_1.queryElement)("#upcomingTableBody");
