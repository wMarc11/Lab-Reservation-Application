...
const currentPassword = queryElement(`#current-password`);
const newPassword = queryElement(`#new-password`);
const confirmNewPassword = queryElement(`#confirm-new-password`);
const updatePassword = queryElement("#update-password");
const passwordMessage = queryElement("#password-message");
