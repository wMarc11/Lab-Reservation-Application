import { LAB_NAMES } from "./labNames.js";
...
export const LAB_SEAT_CONFIG = LAB_NAMES.reduce((config, labName) => {
...
export function getLabsForBuildingFloor(buildingCode, floor) {
...
export function getLabLayout(room) {
    return LAB_SEAT_CONFIG[room]?.layout ?? createGenericLayout(DEFAULT_LAB_CAPACITY);
}
export function getLabCapacity(room) {
    return LAB_SEAT_CONFIG[room]?.capacity ?? DEFAULT_LAB_CAPACITY;
}
...
export function parseFloorNumber(value) {
