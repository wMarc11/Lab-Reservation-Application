...
export class LogInModal {
    ...
    private logInTransition!: HTMLButtonElement;
    private signUpTransition!: HTMLButtonElement;
    private logInCard!: HTMLElement;
    private signInContent!: HTMLElement;
    private hiddableH4!: HTMLElement;
    private errorSignUp!: HTMLElement;
    private errorLogIn!: HTMLElement;
    private signUp!: HTMLButtonElement;
    private logIn!: HTMLButtonElement;
    private logInEmailField!: HTMLInputElement;
    private logInPasswordField!: HTMLInputElement;
    private signUpEmailField!: HTMLInputElement;
    private signUpPasswordField!: HTMLInputElement;
    private rememberMe1!: HTMLInputElement;
    private rememberMe2!: HTMLInputElement;
    /**
    ...
    */
    public displayErrorSignUp(errorMessage = `Invalid Email`) {
    ...
    */
    public displayErrorLogIn(errorMessage = `Invalid Email or Password`) {
        if (errorMessage === undefined) {
            console.warn(`LogInModal Warning: You might have forgot to put an error message`);
        }
        const message = ERROR_ICON + errorMessage;
    ...
    */
    ...
    private init(mode: "LOG_IN" | "SIGN_IN") {
        window.scrollTo(0, 0);
    ...
    */
    private syncRememberMe(whichBox: 1 | 2) {
